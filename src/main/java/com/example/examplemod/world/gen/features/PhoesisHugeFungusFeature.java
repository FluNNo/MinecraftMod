...
public class PhoesisHugeFungusFeature extends Feature<PhoesisHugeFungusConfig> {
    public PhoesisHugeFungusFeature(Codec<PhoesisHugeFungusConfig> p_i231959_1_) {
        super(p_i231959_1_);
    }

    public boolean generate(ISeedReader reader, ChunkGenerator generator, Random rand, BlockPos pos, PhoesisHugeFungusConfig config) {
        Block block = config.valid_base_block_state.getBlock();
    ...
    private void func_236317_a_(IWorld p_236317_1_, Random p_236317_2_, PhoesisHugeFungusConfig p_236317_3_, BlockPos p_236317_4_, int p_236317_5_, boolean p_236317_6_) {
        BlockPos.Mutable blockpos$mutable = new BlockPos.Mutable();
        BlockState blockstate = p_236317_3_.stem_state;
    ...
    private void func_236321_b_(IWorld p_236321_1_, Random p_236321_2_, PhoesisHugeFungusConfig p_236321_3_, BlockPos p_236321_4_, int p_236321_5_, boolean p_236321_6_) {
        BlockPos.Mutable blockpos$mutable = new BlockPos.Mutable();
        boolean flag = p_236321_3_.hat_state.isIn(Blocks.NETHER_WART_BLOCK);
            ...
            for(int i1 = -l; i1 <= l; ++i1) {
                for(int j1 = -l; j1 <= l; ++j1) {
                    ...
                    if (func_236315_a_(p_236321_1_, blockpos$mutable, false)) {
                        if (p_236321_3_.planted && !p_236321_1_.getBlockState(blockpos$mutable.down()).isAir()) {
                            p_236321_1_.destroyBlock(blockpos$mutable, true);
                        }

                        if (flag5) {
                            if (!flag3) {
                                this.func_236318_a_(p_236321_1_, p_236321_2_, blockpos$mutable, p_236321_3_.hat_state, flag);
                            }
                        } else if (flag3) {
    ...
    private void func_236316_a_(IWorld p_236316_1_, Random p_236316_2_, PhoesisHugeFungusConfig p_236316_3_, BlockPos.Mutable p_236316_4_, float p_236316_5_, float p_236316_6_, float p_236316_7_) {
        if (p_236316_2_.nextFloat() < p_236316_5_) {
            this.setBlockState(p_236316_1_, p_236316_4_, p_236316_3_.decor_state);
        } else if (p_236316_2_.nextFloat() < p_236316_6_) {
            this.setBlockState(p_236316_1_, p_236316_4_, p_236316_3_.hat_state);
